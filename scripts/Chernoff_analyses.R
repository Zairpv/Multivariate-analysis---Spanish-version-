#Datos
#Tarea1 
#Presenta: Zaira Rosario Pérez Vázquez - PCF
...
#Conectar folder
setwd("C:/Users/zaira/Documents/01 - Doctorado PCF/Otoño 2020/Analisis multivariado/Tareas_ZRPV/Tarea1")

#Public utility data
datos<-read.csv("public_utility_data.csv",header = TRUE)
View(datos)
summary(datos)
...
#Flu data
flu_datos<-read.csv("flu_data.csv",header = TRUE)
flu_datos
